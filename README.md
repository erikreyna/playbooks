...
My personal Ansible playbooks for various things, primarily setting up new machines. (OSX M chips only for now)

## Pre Installation

- Sign into your icloud account before running this.
- Know that there are some tasks that are particular to my setup here at the moment, steps, you might want to remove those from your local.yml list
